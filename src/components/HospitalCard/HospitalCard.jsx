...
// HospitalCard - displays hospital details with booking functionality
// Has two modes:
// 1. Search mode (booking=false): shows "Book FREE Center Visit" button and calendar
// 2. Booking mode (booking=true): shows booked date and time as chips
    ...
    <Box sx={{ borderRadius: 2, bgcolor: "#fff", p: { xs: 2, md: 4 } }}>
      ...
      >
        ...
        <Box flex={1}>
          ...
          {/* Hospital rating badge - shows 0 if rating is not available */}
          <Stack
            direction="row"
            alignItems="center"
      ...
      {/* Calendar component for selecting booking date/time - only shown in search mode */}
      {showCalendar && (
        <Calendar
          details={details}
