...
// BookingModal - confirmation dialog for hospital appointment booking
// Takes selected hospital details and time slot, asks for user email
// On confirm: saves booking to localStorage and triggers analytics event
export default function BookingModal({
  ...
  // Handle booking confirmation - saves to localStorage and closes modal
  const handleBooking = (e) => {
    e.preventDefault();
    triggerEvent();

    // Retrieve existing bookings and append the new one
