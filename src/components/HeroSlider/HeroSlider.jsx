...
// HeroSlider - main hero section on the home page
// Uses Swiper for potential slide functionality (currently single slide)
// Displays the main tagline, description, and a CTA button to search medical centers
